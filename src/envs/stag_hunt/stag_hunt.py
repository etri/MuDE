...
class StagHunt(MultiAgentEnv):
    ...
    def step(self, actions):
        ...
        # reward decomposition, 210622, edited by bhyoo
        reward_minus = np.zeros(self.batch_size, dtype=float_type)
                ...
                if self.prey_alive[p, b] > 0:
                    ...
                    if self.capture_action:
                        ...
                        if n_catching_agents > 0 and not captured:
                            ...
                            # reward decomposition, 210622, edited by bhyoo
                            reward_minus[b] += self.miscapture_punishment
                    else:
                    ...
                    if captured:
                        ...
                        if not rest:
                            ...
                            u = possible[int(np.random.randint(len(possible)))]
        ...
        # reward decomposition, 210622, edited by bhyoo
        info["reward_minus"] = reward_minus
